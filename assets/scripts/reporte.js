...
window.onload = function () {
	...
	if(window.location.pathname.split('/')[3].toLowerCase() == 'ListarReportesRecaudacion'.toLowerCase())
	{
		cargarGraficosR();
	}

	if(window.location.pathname.split('/')[3].toLowerCase() == 'graficoResumenConsolidado'.toLowerCase())
	{
		cargarGraficosRR();
	}

	if(window.location.pathname.split('/')[3].toLowerCase() == 'graficoResumenConsolidadoRegion'.toLowerCase())
	{
		cargarGraficosCRR();
	}

	/*if(window.location.pathname.split('/')[3].toLowerCase() == 'listarPagosTesoreria'.toLowerCase())
	{
		listarPagosTesoreria();
	}*/
