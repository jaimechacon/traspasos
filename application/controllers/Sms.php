			...
			if($data != null && $data->username != null && $data->password != null)
			{
				if($data->username == "Sglo2019" && $data->password == "Sg.2019$$##")
				{
					...
					if(sizeof($datos) == 5){
						...
						$query = $this->Sms_model->saveSms($data->username, $data->password, $data->ani, $data->dnis, $data->message.var_dump($datos), $data->other_messages); #$rut, $serie, $tipo_documento, $telefono, $folio);
					}
				}
			}
		}
